                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <img v-if="form.avatarUrl" :src="form.avatarUrl" alt="Avatar Preview" class="w-12 h-12 object-cover rounded-full">
                        </div>
                    </div>
                </div>
...
export default {
    ...
    setup() {
        const form = useForm({
            ...
            password: null,
            avatar: null,
            avatarUrl: null, // Добавлено свойство для предварительного просмотра
        });
        ...
        return { form, store, handleAvatarChange };
    },
};
</script>
